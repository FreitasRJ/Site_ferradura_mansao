...
const FloatingWhatsApp: React.FC = () => (
  <a 
    href={`https://wa.me/${MANSION_DATA.whatsapp.replace('+', '')}`}
    target="_blank" rel="noopener noreferrer"
    className="fixed bottom-32 right-8 z-[110] w-16 h-16 bg-[#25d366] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform animate-bounce hover:animate-none"
  >
